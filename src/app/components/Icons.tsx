  ...
  return (
    <>
      <div className="text-white">
        <h1
          className={`${lora.className} text-5xl text-white pt-90 tracking-wide`}
        >
          Loved by{" "}
      ...
      <div className="flex pt-10">
        <div className="flex-row">
          <div className="w-110 h-60 bg-white/5 backdrop-blur-lg border-white/10 rounded-xl m-2 flex items-center justify-center">
            <img src="/tradingview.svg" alt="logo" className="w-44 h-44" />
          </div>
          <div className="w-110 h-60 bg-white/5 backdrop-blur-lg border-white/10 rounded-xl m-2 flex items-center justify-center">
            <img src="/ethereum.png" alt="logo" className="w-44 h-44" />
          </div>
        </div>
